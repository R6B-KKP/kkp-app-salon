...
import component.scroll.ScrollBarCustom;
...
public class ComboBoxCustome<E> extends JComboBox<E> {
    ...
    private class ComboUI extends BasicComboBoxUI {
        ...
        private ComboBoxCustome combo;

        public ComboUI(ComboBoxCustome combo) {
            this.combo = combo;
...
//                    arrowButton.setBackground(new Color(150, 150, 150));
        ...
        protected ComboPopup createPopup() {
            ...
            pop.setBorder(new LineBorder(new Color(255, 255, 255), 1));
            return pop;
        }
        ...
        private class ArrowButton extends JButton {
            ...
            public ArrowButton() {
                ...
                setBorder(new EmptyBorder(5, 5, 10, 53));
